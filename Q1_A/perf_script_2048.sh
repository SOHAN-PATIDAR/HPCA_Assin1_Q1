...
source_files=(
    "mat_2048_malloc_ijk.cpp"
    "mat_2048_malloc_jik.cpp"
    "mat_2048_malloc_kij.cpp"
)
...
output_dir="D:\\HPCA_assign_Q1\\Q1_A_output"
mkdir -p $output_dir  # Create the directory if it doesn't exist
 
# Output file for all results
output_file="${output_dir}/all_2048_malloc_programs_output.txt"
